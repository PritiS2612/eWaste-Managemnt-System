...
$formid=$_GET['cid'];
$isread=1;
$sql=" update  tblpickupdata set Is_Read=:isread where id=:cfid";
...
if($lastInsertId)
{
 echo "<script>alert('Details updated successfully.');</script>";
  echo "<script>window.location.href='all schedules.php'</script>";
} else {
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Schedule Details</h3>
...
$sql = "SELECT tblpickupdata.FullName,tblpickupdata.PhoneNumber,tblpickupdata.UserIp,tblpickupdata.EmailId,tblpickupdata.Message,tblpickupdata.PostingDate,tblpickupdata.id from tblpickupdata  where tblpickupdata.id=:fid";
$query = $dbh -> prepare($sql);
